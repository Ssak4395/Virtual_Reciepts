...
public class ImageTutorial {
    ...
    public ImageTutorial(Activity activity) {
    ...
    private void startDialog() {
        ...
        View v = layoutInflater.inflate(R.layout.image_tutorial,null);
    ...
    private void linkClose(Button close, CheckBox checkBox) {
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                User.setNeedsImageTutorial(!checkBox.isChecked());
                alertDialog.dismiss();
                try {
                    Method m = activity.getClass().getMethod("openCamera", null);
                    m.invoke(activity);
